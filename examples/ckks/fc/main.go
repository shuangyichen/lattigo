...
func main() {
	...
	// pt_w := encoder.EncodeNew(weights_value, params.MaxLevel(), params.DefaultScale(), params.LogSlots())
	...
	for i := 0; i < sample_num; i++ {
		...
		// ct_result[i] = fc(params, ct_f1[i], pt_w, filters, F_H_out*F_W_out*filters, evaluator, decryptor, encoder)
